...
func tableAkeylessAkeylessRotatedSecretCassandra() *plugin.Table {
	return &plugin.Table{
		Name:        "akeyless_akeyless_rotated_secret_cassandra",
		Description: "Manages a Cassandra rotated secret",
		List: &plugin.ListConfig{
			Hydrate: listAkeylessAkeylessRotatedSecretCassandra,
		},
		Columns: akeylessAkeylessRotatedSecretCassandraColumns(),
	}
}

func akeylessAkeylessRotatedSecretCassandraColumns() []*plugin.Column {
...
func listAkeylessAkeylessRotatedSecretCassandra(ctx context.Context, d *plugin.QueryData, _ *plugin.HydrateData) (interface{}, error) {
