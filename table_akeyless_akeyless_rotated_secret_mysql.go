...
func tableAkeylessAkeylessRotatedSecretMysql() *plugin.Table {
	return &plugin.Table{
		Name:        "akeyless_akeyless_rotated_secret_mysql",
		Description: "Manages a MySQL rotated secret",
		List: &plugin.ListConfig{
			Hydrate: listAkeylessAkeylessRotatedSecretMysql,
		},
		Columns: akeylessAkeylessRotatedSecretMysqlColumns(),
	}
}

func akeylessAkeylessRotatedSecretMysqlColumns() []*plugin.Column {
...
func listAkeylessAkeylessRotatedSecretMysql(ctx context.Context, d *plugin.QueryData, _ *plugin.HydrateData) (interface{}, error) {
