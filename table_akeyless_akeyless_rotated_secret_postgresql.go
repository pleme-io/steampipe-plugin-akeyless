...
func tableAkeylessAkeylessRotatedSecretPostgresql() *plugin.Table {
	return &plugin.Table{
		Name:        "akeyless_akeyless_rotated_secret_postgresql",
		Description: "Manages a PostgreSQL rotated secret",
		List: &plugin.ListConfig{
			Hydrate: listAkeylessAkeylessRotatedSecretPostgresql,
		},
		Columns: akeylessAkeylessRotatedSecretPostgresqlColumns(),
	}
}

func akeylessAkeylessRotatedSecretPostgresqlColumns() []*plugin.Column {
...
func listAkeylessAkeylessRotatedSecretPostgresql(ctx context.Context, d *plugin.QueryData, _ *plugin.HydrateData) (interface{}, error) {
