...
func tableAkeylessAkeylessRotatedSecretRedis() *plugin.Table {
	return &plugin.Table{
		Name:        "akeyless_akeyless_rotated_secret_redis",
		Description: "Manages a Redis rotated secret",
		List: &plugin.ListConfig{
			Hydrate: listAkeylessAkeylessRotatedSecretRedis,
		},
		Columns: akeylessAkeylessRotatedSecretRedisColumns(),
	}
}

func akeylessAkeylessRotatedSecretRedisColumns() []*plugin.Column {
...
func listAkeylessAkeylessRotatedSecretRedis(ctx context.Context, d *plugin.QueryData, _ *plugin.HydrateData) (interface{}, error) {
