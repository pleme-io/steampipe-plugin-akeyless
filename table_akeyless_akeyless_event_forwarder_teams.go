...
func tableAkeylessAkeylessEventForwarderTeams() *plugin.Table {
	return &plugin.Table{
		Name:        "akeyless_akeyless_event_forwarder_teams",
		Description: "Manages a Microsoft Teams event forwarder in Akeyless Vault",
		List: &plugin.ListConfig{
			Hydrate: listAkeylessAkeylessEventForwarderTeams,
		},
		Columns: akeylessAkeylessEventForwarderTeamsColumns(),
	}
}

func akeylessAkeylessEventForwarderTeamsColumns() []*plugin.Column {
...
func listAkeylessAkeylessEventForwarderTeams(ctx context.Context, d *plugin.QueryData, _ *plugin.HydrateData) (interface{}, error) {
