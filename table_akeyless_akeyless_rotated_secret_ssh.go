...
func tableAkeylessAkeylessRotatedSecretSsh() *plugin.Table {
	return &plugin.Table{
		Name:        "akeyless_akeyless_rotated_secret_ssh",
		Description: "Manages an SSH rotated secret",
		List: &plugin.ListConfig{
			Hydrate: listAkeylessAkeylessRotatedSecretSsh,
		},
		Columns: akeylessAkeylessRotatedSecretSshColumns(),
	}
}

func akeylessAkeylessRotatedSecretSshColumns() []*plugin.Column {
	return []*plugin.Column{
		...
		{
			Name:        "secure_access_target_type",
			Type:        proto.ColumnType_STRING,
...
func listAkeylessAkeylessRotatedSecretSsh(ctx context.Context, d *plugin.QueryData, _ *plugin.HydrateData) (interface{}, error) {
