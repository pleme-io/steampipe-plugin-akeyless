...
func tableAkeylessAkeylessRotatedSecretSnowflake() *plugin.Table {
	return &plugin.Table{
		Name:        "akeyless_akeyless_rotated_secret_snowflake",
		Description: "Manages a Snowflake rotated secret",
		List: &plugin.ListConfig{
			Hydrate: listAkeylessAkeylessRotatedSecretSnowflake,
		},
		Columns: akeylessAkeylessRotatedSecretSnowflakeColumns(),
	}
}

func akeylessAkeylessRotatedSecretSnowflakeColumns() []*plugin.Column {
...
func listAkeylessAkeylessRotatedSecretSnowflake(ctx context.Context, d *plugin.QueryData, _ *plugin.HydrateData) (interface{}, error) {
