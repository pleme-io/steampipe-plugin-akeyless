...
func tableAkeylessAkeylessRotatedSecretAws() *plugin.Table {
	return &plugin.Table{
		Name:        "akeyless_akeyless_rotated_secret_aws",
		Description: "Manages an AWS rotated secret",
		List: &plugin.ListConfig{
			Hydrate: listAkeylessAkeylessRotatedSecretAws,
		},
		Columns: akeylessAkeylessRotatedSecretAwsColumns(),
	}
}

func akeylessAkeylessRotatedSecretAwsColumns() []*plugin.Column {
...
func listAkeylessAkeylessRotatedSecretAws(ctx context.Context, d *plugin.QueryData, _ *plugin.HydrateData) (interface{}, error) {
