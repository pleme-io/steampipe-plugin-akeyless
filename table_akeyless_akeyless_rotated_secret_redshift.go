...
func tableAkeylessAkeylessRotatedSecretRedshift() *plugin.Table {
	return &plugin.Table{
		Name:        "akeyless_akeyless_rotated_secret_redshift",
		Description: "Manages a Redshift rotated secret",
		List: &plugin.ListConfig{
			Hydrate: listAkeylessAkeylessRotatedSecretRedshift,
		},
		Columns: akeylessAkeylessRotatedSecretRedshiftColumns(),
	}
}

func akeylessAkeylessRotatedSecretRedshiftColumns() []*plugin.Column {
...
func listAkeylessAkeylessRotatedSecretRedshift(ctx context.Context, d *plugin.QueryData, _ *plugin.HydrateData) (interface{}, error) {
