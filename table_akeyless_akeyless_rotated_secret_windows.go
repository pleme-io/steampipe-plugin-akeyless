...
func tableAkeylessAkeylessRotatedSecretWindows() *plugin.Table {
	return &plugin.Table{
		Name:        "akeyless_akeyless_rotated_secret_windows",
		Description: "Manages a Windows rotated secret",
		List: &plugin.ListConfig{
			Hydrate: listAkeylessAkeylessRotatedSecretWindows,
		},
		Columns: akeylessAkeylessRotatedSecretWindowsColumns(),
	}
}

func akeylessAkeylessRotatedSecretWindowsColumns() []*plugin.Column {
...
func listAkeylessAkeylessRotatedSecretWindows(ctx context.Context, d *plugin.QueryData, _ *plugin.HydrateData) (interface{}, error) {
