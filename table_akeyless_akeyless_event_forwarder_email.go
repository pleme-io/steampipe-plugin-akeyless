...
func tableAkeylessAkeylessEventForwarderEmail() *plugin.Table {
	return &plugin.Table{
		Name:        "akeyless_akeyless_event_forwarder_email",
		Description: "Manages an email event forwarder in Akeyless Vault",
		List: &plugin.ListConfig{
			Hydrate: listAkeylessAkeylessEventForwarderEmail,
		},
		Columns: akeylessAkeylessEventForwarderEmailColumns(),
	}
}

func akeylessAkeylessEventForwarderEmailColumns() []*plugin.Column {
...
func listAkeylessAkeylessEventForwarderEmail(ctx context.Context, d *plugin.QueryData, _ *plugin.HydrateData) (interface{}, error) {
