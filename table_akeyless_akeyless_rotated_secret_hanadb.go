...
func tableAkeylessAkeylessRotatedSecretHanadb() *plugin.Table {
	return &plugin.Table{
		Name:        "akeyless_akeyless_rotated_secret_hanadb",
		Description: "Manages a HanaDB rotated secret",
		List: &plugin.ListConfig{
			Hydrate: listAkeylessAkeylessRotatedSecretHanadb,
		},
		Columns: akeylessAkeylessRotatedSecretHanadbColumns(),
	}
}

func akeylessAkeylessRotatedSecretHanadbColumns() []*plugin.Column {
...
func listAkeylessAkeylessRotatedSecretHanadb(ctx context.Context, d *plugin.QueryData, _ *plugin.HydrateData) (interface{}, error) {
