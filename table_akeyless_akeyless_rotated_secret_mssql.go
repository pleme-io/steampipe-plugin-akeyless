...
func tableAkeylessAkeylessRotatedSecretMssql() *plugin.Table {
	return &plugin.Table{
		Name:        "akeyless_akeyless_rotated_secret_mssql",
		Description: "Manages a MSSQL rotated secret",
		List: &plugin.ListConfig{
			Hydrate: listAkeylessAkeylessRotatedSecretMssql,
		},
		Columns: akeylessAkeylessRotatedSecretMssqlColumns(),
	}
}

func akeylessAkeylessRotatedSecretMssqlColumns() []*plugin.Column {
...
func listAkeylessAkeylessRotatedSecretMssql(ctx context.Context, d *plugin.QueryData, _ *plugin.HydrateData) (interface{}, error) {
