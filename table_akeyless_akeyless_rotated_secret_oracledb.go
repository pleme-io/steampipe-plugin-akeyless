...
func tableAkeylessAkeylessRotatedSecretOracledb() *plugin.Table {
	return &plugin.Table{
		Name:        "akeyless_akeyless_rotated_secret_oracledb",
		Description: "Manages an OracleDB rotated secret",
		List: &plugin.ListConfig{
			Hydrate: listAkeylessAkeylessRotatedSecretOracledb,
		},
		Columns: akeylessAkeylessRotatedSecretOracledbColumns(),
	}
}

func akeylessAkeylessRotatedSecretOracledbColumns() []*plugin.Column {
...
func listAkeylessAkeylessRotatedSecretOracledb(ctx context.Context, d *plugin.QueryData, _ *plugin.HydrateData) (interface{}, error) {
